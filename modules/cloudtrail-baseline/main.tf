...
resource "aws_kms_key" "cloudtrail" {
  count = var.enabled && var.kms_enabled ? 1 : 0
...
resource "aws_sns_topic" "cloudtrail-sns-topic" {
  ...
  kms_master_key_id = var.kms_enabled ? aws_kms_key.cloudtrail[0].id : null
}
...
resource "aws_cloudtrail" "global" {
  ...
  kms_key_id                    = var.kms_enabled ? aws_kms_key.cloudtrail[0].arn : null
